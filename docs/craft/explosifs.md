...
**Échelle corrigée terrain ✅** : **bois = niv. 1** (pas 2 comme le disaient les guides PC), pierre et béton aux niveaux supérieurs. ⚠️ Les fiches de **structures** n'affichent pas de numéro de stabilité (Durabilité + Coût seulement) — ces niveaux ne se lisent que sur les fiches d'**explosifs**. Deux précisions vérifiées depuis : le palier « **pierre** » (« Mur en pierre 01 », décrit *« Mur de briques »*) et la brique sont **un seul et même palier** (1 800 PV, contre 3 200 au béton) ; et le béton n'est **pas le sommet** — l'onglet **Amélioration de structure** du Terminal de territoire (capturé 09/09/2026) ouvre des filières supérieures (Structure en Pierre, Métallique, **en alliage**, dont des **Fondations en marbre**), verrouillées par technologies. Les fondations en marbre à 6 400 PV rencontrées en zone d'affrontements sont donc des structures améliorées, atteignables par les joueurs.
