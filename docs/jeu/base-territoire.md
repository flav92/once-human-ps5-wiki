...
**Le coût : la dégradation des structures.** Elle s'applique aux structures de la base et la réparation **dépend du matériau** : la **brique coûte cher**, la **pierre est moins chère**. La ferme testée est construite **en brique** (réparation chère, mais le joueur était déjà au tungstène avec un gros stock de métaux — le coût passe). Si vous partez de zéro : la **pierre** offre un meilleur rapport solidité/coût de réparation. Gardez la base **compacte** : moins de surface = moins de réparations. *(Test comparatif en cours ✅ : deux fermes jumelles tournent en parallèle, une en **brique** et une en **bois** — chiffres de dégradation et de réparation comparés à venir.)*
