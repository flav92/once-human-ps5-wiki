...
- [x] ~~**Fiche d'un mur/fondation en BÉTON**~~ ✅ 08/09 : **Mur en béton 01 = 3 200 PV**. Les fiches de structures n'affichent PAS de numéro de stabilité
- [x] ~~**Fiche d'un plafond en BRIQUE**~~ ✅ 08/09 : « Plafond en pierre 01 » = **1 800 PV** — et sa description dit « Mur de briques » : **pierre = brique en jeu**
- [x] ~~**Fiche d'un élément en PIERRE**~~ ✅ 08/09 : même palier que la brique (Mur en pierre 01, 1 800 PV)
...
- [ ] 🔥 **HUD de zone avec chaque compteur identifié** → piste sérieuse depuis le 08/09 : ce sont probablement les **quotas de construction** (Structures/Meubles/Installations/Courant, comme sur le territoire perso) — à confirmer en zone
